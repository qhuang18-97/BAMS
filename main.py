...
if args.commnet:
     ...
     #d = torch.load('/home/qhuang/decoder/pret/model_tmc+map_iter1000_1998')
     # d = torch.load('best_succ_ml')
     # log.clear()
...
def run(num_epochs):
    ...
    for ep in range(num_epochs):
        ...
        #stat['map_loss'] = stat['map_loss'] / stat['num_episodes']
        ...
        # if 'min_steps' in stat.keys():
        #     print('Min_steps: {}'.format(stat['min_steps']))
